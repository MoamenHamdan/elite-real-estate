...
import { FiPlus, FiGrid, FiTrendingUp, FiSettings, FiLogOut, FiHome, FiDollarSign, FiPieChart, FiList, FiUsers, FiMail } from 'react-icons/fi';
...
export default function AdminLayout({ children }) {
    ...
    const menuItems = [
        ...
        { id: 'messages', label: 'Messages', icon: FiMail, href: '/adminofthepage/messages' },
